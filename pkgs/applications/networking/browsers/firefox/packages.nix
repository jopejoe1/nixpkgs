...

{
  ...
  firefox-beta = buildMozillaMach rec {
    ...
    src = fetchurl {
      url = "mirror://mozilla/firefox/releases/${version}/source/firefox-${version}.source.tar.xz";
      sha512 = "79e56261db61bc748852e3f42aff47a22d0f71a6688e822e40299bcc0328d3be5ead37d6a9b7eb00362b6a4b69c5e54b50b7a0a52d478f481173a0cf388c798a";
    };
  ...
  firefox-devedition = buildMozillaMach rec {
    ...
    src = fetchurl {
      ...
      sha512 = "df2e2bb727b006b59b17c6a71722c8e2279dfd35ee46454ef207769e7106e3e9abdc7e6c77c119f33ed6e885dd9f51856553146c7f9f87e6e3b95eb3a6aa0048";
    };
