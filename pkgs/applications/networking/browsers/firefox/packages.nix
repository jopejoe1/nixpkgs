...

{
  ...
  firefox-beta = buildMozillaMach rec {
    ...
    src = fetchurl {
      url = "mirror://mozilla/firefox/releases/${version}/source/firefox-${version}.source.tar.xz";
      sha512 = "0536caff3ab7ed4f35691ccc5ef167b56dbfd54944f8eeb2d0ae441e4de6b2bdb6ddd352dd6a66af643d3d48334f9895ddd004be11dd5458a23aba985cca16ed";
    };
  ...
  firefox-devedition = buildMozillaMach rec {
    ...
    src = fetchurl {
      ...
      sha512 = "ea5fad5093f294faf1a22eed2e1cd66b92ccb0c78eda400be8a5ae1da635465d94a71a001ab0e349de9fd87d26ca018139793d4f00d6883f9eda37f772a6b3ea";
    };
