...
let
  ...
  inherit (darwin.apple_sdk.frameworks) AppKit AudioToolbox AVFoundation CoreImage VideoToolbox;
in
...
stdenv.mkDerivation (finalAttrs: {
  ...
  meta = with lib; {
    ...
    changelog = "https://github.com/FFmpeg/FFmpeg/blob/${finalAttrs.src.rev}/Changelog";
    longDescription = ''
