...
# On runtime fails with dyld[25216]: Library not loaded: libquirc.so.1.2 (Seems to not link th)
...
, withXevd ? withFullDeps && lib.versionAtLeast version "7" && !stdenv.isDarwin # MPEG-5 EVC decoding
