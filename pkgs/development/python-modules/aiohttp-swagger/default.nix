...
buildPythonPackage rec {
  ...
  patches = [
    (fetchpatch {
      url = "https://github.com/cr0hn/aiohttp-swagger/commit/a4be5331c8a50d46ea64c4c69e00292300245f3b.patch";
      hash = "sha256-lPrXzctXl6aNr+SIUpqAFhq49hMeoqTFfckvh5awgPQ=";
    })
    (fetchpatch {
      url = "https://github.com/cr0hn/aiohttp-swagger/commit/968f40b23e5bf5cc3e19053c764806574026d3e7.patch";
